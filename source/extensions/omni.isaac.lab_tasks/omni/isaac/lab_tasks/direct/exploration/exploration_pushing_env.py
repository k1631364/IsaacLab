...
@configclass
class ExplorationPushingEnvCfg(DirectRLEnvCfg):
    # simulation
...
class ExplorationPushingEnv(DirectRLEnvFeedback):
    cfg: ExplorationPushingEnvCfg

    def __init__(self, cfg: ExplorationPushingEnvCfg, render_mode: str | None = None, **kwargs):
