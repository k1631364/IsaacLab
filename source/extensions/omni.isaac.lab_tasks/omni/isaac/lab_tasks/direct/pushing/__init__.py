...
from .pushing_env import PushingEnv, PushingEnvCfg
...
gym.register(
    id="Isaac-Pushing-Direct-v0",
    entry_point="omni.isaac.lab_tasks.direct.pushing:PushingEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": PushingEnvCfg,
