...
@configclass
class SlidingPandaGymExpEnvCfg(DirectRLEnvCfg):
    # simulation
...
class SlidingPandaGymExpEnv(DirectRLEnv):
    cfg: SlidingPandaGymExpEnvCfg

    def __init__(self, cfg: SlidingPandaGymExpEnvCfg, render_mode: str | None = None, **kwargs):
