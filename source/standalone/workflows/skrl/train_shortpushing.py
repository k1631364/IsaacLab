...
from source.skrl_custom.models.custom_models import custom_gaussian_model, custom_gaussian_model2, custom_gaussian_model_rnn2, custom_deterministic_model, custom_deterministic_model_rnn2 
...
from omni.isaac.lab_tasks.utils.wrappers.skrl_prop import SkrlSequentialLogTrainer_Prop #, SkrlVecEnvWrapper, process_skrl_cfg
...
def main():
    ...
    experiment_cfg["models"]["policy"]["num_envs"] = env.num_envs
    experiment_cfg["models"]["value"]["num_envs"] = env.num_envs
    ...
    agent_cfg["prop_estimator"]["train"] = True
